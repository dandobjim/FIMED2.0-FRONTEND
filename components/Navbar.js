		...
		<nav className="navbar navbar-default navbar-fixed-top">
			...
			<div className="container">
				<div className="navbar-header">
					...
					<Link href="/home">
						<a className="navbar-brand" css={css`
								padding-top: 0 !important;
								padding-left: 15px !important;
						`}>
							<img src="/static/img/logo.png" css={css`
									height: 40px;
							`} />
						</a>
					</Link>
				</div>
				<div className="collapse navbar-collapse" id="myNavbar" css={css`color: #d58512;`}>
					<ul className="nav navbar-nav">
						...
						<li className="dropdown">
							<a href="#" className="dropdown-toggle" data-toggle="dropdown"><strong>About us</strong> <span className="caret"></span></a>
							<ul className="dropdown-menu">
								<li>
									<Link href="/aboutUS">
						...
						<li>
							<Link href="/manual">
								<a><strong>Help</strong> <span className=" glyphicon glyphicon-info-sign"></span></a>
							</Link>
						</li>
					</ul>
					<ul className="nav navbar-nav navbar-right">
						<li>
							<Link href="/logoutAction">
								<a><strong>Logout</strong> <span className="glyphicon glyphicon-log-out"></span></a>
							</Link>
						</li>
					</ul>
				</div>
